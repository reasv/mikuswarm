...
// ─────────────────────────────────────────────────────────────────────────────
test("adversarial/schema: LATEST_SCHEMA_VERSION = 15; all four expected indexes present on fresh DB", async () => {
  assert.equal(LATEST_SCHEMA_VERSION, 15, "LATEST_SCHEMA_VERSION is 15");
