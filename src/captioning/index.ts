...
export { describeMedia, describeImage, type CaptionModelConfig, type DescribeMediaOptions, type DescribeMediaResult, type DescribeImageOptions, type DescribeImageResult, type MediaModality } from "./describe.js";
