...
pub use types::{
    ...
    MatrixInboundEvent, MatrixInboundMedia, MatrixInboundMentions, MatrixJoinRequest,
    MatrixJoinResult, MatrixKeyBackupState, MatrixLinkPreviewMedia, MatrixLinkPreviewResult,
